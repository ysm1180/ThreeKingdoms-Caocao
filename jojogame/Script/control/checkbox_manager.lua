...
CheckBoxManager = Object:Instance 
{
    ...
    -- @return CheckBox : 생성된 CheckBox class
    -- @type CheckBoxOptions table
    --[[
        {
    ...
    -- @description 체크 박스 컨트롤을 CheckBox class 로 wrapping 하여 생성
    -- @param control control : CheckBox control
    -- @return CheckBox : CheckBox control -> CheckBox class

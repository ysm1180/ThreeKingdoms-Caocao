...
template<typename RVal>
RVal call(lua_State* L, const wchar_t* name) {
  char callName[256] = {};
...
template<typename RVal, typename T1>
RVal call(lua_State* L, const wchar_t* name, T1 arg) {
  char callName[256] = {};
  size_t convertedSize = 0;
  wcstombs_s(&convertedSize, callName, wcslen(name) + 1, name, wcslen(name));
...
template<typename RVal, typename T1, typename T2>
RVal call(lua_State* L, const wchar_t* name, T1 arg1, T2 arg2) {
  char callName[256] = {};
  size_t convertedSize = 0;
  wcstombs_s(&convertedSize, callName, wcslen(name) + 1, name, wcslen(name));
...
template<typename RVal, typename T1, typename T2, typename T3>
RVal call(lua_State* L, const wchar_t* name, T1 arg1, T2 arg2, T3 arg3) {
  char callName[256] = {};
  size_t convertedSize = 0;
  wcstombs_s(&convertedSize, callName, wcslen(name) + 1, name, wcslen(name));
...
template<typename RVal, typename T1, typename T2, typename T3, typename T4>
RVal call(lua_State* L, const wchar_t* name, T1 arg1, T2 arg2, T3 arg3, T4 arg4) {
  char callName[256] = {};
  size_t convertedSize = 0;
  wcstombs_s(&convertedSize, callName, wcslen(name) + 1, name, wcslen(name));
...
template<typename RVal, typename T1, typename T2, typename T3, typename T4, typename T5>
RVal call(lua_State* L, const wchar_t* name, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5) {
  char callName[256] = {};
  size_t convertedSize = 0;
  wcstombs_s(&convertedSize, callName, wcslen(name) + 1, name, wcslen(name));
...
template<typename RVal, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
RVal call(lua_State* L, const wchar_t* name, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) {
  char callName[256] = {};
  size_t convertedSize = 0;
  wcstombs_s(&convertedSize, callName, wcslen(name) + 1, name, wcslen(name));
...
template<typename RVal, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7>
RVal call(lua_State* L, const wchar_t* name, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) {
  char callName[256] = {};
  size_t convertedSize = 0;
  wcstombs_s(&convertedSize, callName, wcslen(name) + 1, name, wcslen(name));
...
template<typename RVal, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8>
RVal call(lua_State* L, const wchar_t* name, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) {
  char callName[256] = {};
  size_t convertedSize = 0;
  wcstombs_s(&convertedSize, callName, wcslen(name) + 1, name, wcslen(name));

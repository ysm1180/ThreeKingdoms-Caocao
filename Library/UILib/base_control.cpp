...
CBaseControl::~CBaseControl() {
  ...
  if (_mouseLButtonUpEvent != LUA_NOREF) {
    luaL_unref(LuaTinkerHelper::GetLuaTinker().GetLuaState(), LUA_REGISTRYINDEX,
               _mouseLButtonUpEvent);
  }
  if (_mouseLButtonDownEvent != LUA_NOREF) {
    luaL_unref(LuaTinkerHelper::GetLuaTinker().GetLuaState(), LUA_REGISTRYINDEX,
               _mouseLButtonDownEvent);
  }
...
bool CBaseControl::IsHover() const { return _isHover; }

bool CBaseControl::IsPressed() const { return _isPressed; }

inline bool CBaseControl::IsEnabled() const { return _isEnabled; }

inline bool CBaseControl::IsVisible() const { return _isVisible; }

inline int CBaseControl::GetWidth() const { return _size.cx; }

inline int CBaseControl::GetHeight() const { return _size.cy; }
...
inline LONG CBaseControl::GetStyle() const { return _style; }

int CBaseControl::GetCreateEvent() const { return _createEvent; }

int CBaseControl::GetDestroyEvent() const { return _destroyEvent; }
...
int CBaseControl::GetMouseMoveEvent() const { return _mouseMoveEvent; }

int CBaseControl::GetMouseEnterEvent() const { return _mouseEnterEvent; }

int CBaseControl::GetMouseLeaveEvent() const { return _mouseLeaveEvent; }

inline HWND CBaseControl::GetHWnd() const { return _hWnd; }

std::wstring CBaseControl::GetUserData() { return _userData; }

std::wstring CBaseControl::GetType() { return _type; }

  ...
  switch (iMessage) {
    ...
    case WM_LBUTTONUP: {
      ...
      if (mouseLButtonUpEvent != LUA_NOREF) {
        CLuaTinker::GetLuaTinker().Call(mouseLButtonUpEvent, button,
    ...
    case WM_LBUTTONDOWN: {
      ...
      if (mouseLButtonDownEvent != LUA_NOREF) {
        CLuaTinker::GetLuaTinker().Call(mouseLButtonDownEvent, button,
                                        (int)wParam, GET_X_LPARAM(lParam),
                                        GET_Y_LPARAM(lParam));
      }
    ...
    case WM_MOUSEMOVE: {
      ...
      if (mouseMoveEvent != LUA_NOREF) {
        CLuaTinker::GetLuaTinker().Call(mouseMoveEvent, button, (int)wParam,
                                        GET_X_LPARAM(lParam),
                                        GET_Y_LPARAM(lParam));
      }

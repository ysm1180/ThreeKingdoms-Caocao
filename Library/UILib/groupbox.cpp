  ...
  switch (msg) {
    case WM_CREATE: {
      ...
      if (createEvent != LUA_NOREF) {
        LuaTinkerHelper::GetLuaTinker().Call(createEvent, groupBoxControl);
      }
      break;
    }
    ...
    case WM_LBUTTONUP: {
      ...
      if (mouseLButtonUpEvent != LUA_NOREF) {
        LuaTinkerHelper::GetLuaTinker().Call(mouseLButtonUpEvent, groupBoxControl,
    ...
    case WM_MOUSEMOVE: {
      ...
      if (mouseMoveEvent != LUA_NOREF) {
        LuaTinkerHelper::GetLuaTinker().Call(mouseMoveEvent, groupBoxControl,
                                        (int)wParam, GET_X_LPARAM(lParam),
                                        GET_Y_LPARAM(lParam));
      }
    ...
    case WM_MOUSEHOVER: {
      ...
      if (mouseHoverEvent != LUA_NOREF) {
        LuaTinkerHelper::GetLuaTinker().Call(mouseHoverEvent, groupBoxControl);
      }
    ...
    case WM_MOUSELEAVE: {
      ...
      if (mouseLeaveEvent != LUA_NOREF) {
        LuaTinkerHelper::GetLuaTinker().Call(mouseLeaveEvent, groupBoxControl);
      }
    ...
    case WM_DESTROY: {
      ...
      if (destroyEvent != LUA_NOREF) {
        LuaTinkerHelper::GetLuaTinker().Call(destroyEvent, groupBoxControl);
      }

  ...
  switch (iMessage) {
    ...
    case WM_KEYDOWN: {
      ...
      if (keyDownEvent != LUA_NOREF) {
        CLuaTinker::GetLuaTinker().Call(keyDownEvent, window, (int)wParam);
      }
      break;
    }
    ...
    case WM_KEYUP: {
      ...
      if (keyUpEvent != LUA_NOREF) {
        CLuaTinker::GetLuaTinker().Call(keyUpEvent, window, (int)wParam);
      }
      break;
    }
    ...
    case WM_LBUTTONUP: {
      ...
      if (mouseLButtonUpEvent != LUA_NOREF) {
        ...
        CLuaTinker::GetLuaTinker().Call(mouseLButtonUpEvent, window,
    ...
    case WM_LBUTTONDOWN: {
      ...
      if (mouseLButtonDownEvent != LUA_NOREF) {
        ...
        CLuaTinker::GetLuaTinker().Call(mouseLButtonDownEvent, window,
                                        (int)wParam, GET_X_LPARAM(lParam), y);
      }
      break;
    }
    ...
    case WM_MOUSEMOVE: {
      ...
      if (mouseMoveEvent != LUA_NOREF) {
        ...
        CLuaTinker::GetLuaTinker().Call(mouseMoveEvent, window, (int)wParam,
    ...
    case WM_CLOSE: {
      ...
      if (closeEvent != LUA_NOREF) {
        ...
        const auto notClose =
            CLuaTinker::GetLuaTinker().Call<bool>(closeEvent, window);
        if (notClose) {
          return 0;
        }
      }
        ...
        if (listView) {
          ...
          if (row->IsEnabled()) {
            ...
            if (itemActiveEvent != LUA_NOREF) {
              CLuaTinker::GetLuaTinker().Call<void>(

...
---@class ControlManager @Control 생성 관리 클래스
ControlManager = {
    BASE_CONTROL = {
    ...
    ParseFromXML = function(self, file, parentWindow)
        ...
        local function SetAttributeGroup(control, name, value)
            if name == "text" then
        ...
        parser = SLAXML:parser{
            startElement = function(name, nsURI, nsPrefix)
                ...
                if name == XML_CONTROL_NAME.WINDOW then
                    window = Window:New(parentWindow)
            ...
            attribute = function(name, value, nsURI, nsPrefix)
                ...
                elseif childControlTypes[1] == XML_CONTROL_NAME.GROUPBOX then
                    SetAttributeGroup(groupbox, name, value)
                end

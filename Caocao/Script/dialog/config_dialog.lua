...
configDialog, childs = ControlManager:ParseFromXML("../dialog/config_dialog.dlg", main)

childs["btnCancel"]:SetMouseLButtonUpEvent(function()
    configDialog:Close()
end)

childs["btnOK"]:SetMouseLButtonUpEvent(function()
...
configDialog:Move(WindowManager:GetCenterPosition(mainWindow, configDialog:Width(), configDialog:Height()))
